...
@RequestMapping("/reppedidoscaja/")

public class RepPedidosCajaController {
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response, 
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", RepPedidosCajaController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();
        
        
        ModelAndView x = new ModelAndView("reppedidoscaja/startup", "title", "Remisiones");
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getPedidosCajaJson(
        ...
        log.log(Level.INFO, "Ejecutando getPedidosCajaJson de {0}", RepPedidosCajaController.class.getName());
        HashMap<String,ArrayList<HashMap<String, String>>> jsonretorno = new HashMap<String,ArrayList<HashMap<String, String>>>();
        ...
        pedidos = this.getPedidDao().getReportePedidosCaja(opcion,agente, cliente.toUpperCase(), fecha_inicial, fecha_final,id_empresa);
...
//        Integer idcliente = Integer.parseInt(cliente);
       //(HashMap<String, String> datosEncabezadoPie, String fileout, ArrayList<HashMap<String, String>> lista_CobranzaDiaria, HashMap<String, String> datos)
        ...
        try {
            ...
            Logger.getLogger(RepPedidosCajaController.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
